...
nDAX is an open-source cloud-native multi-service platform for building a Blockchain/FinTech exchange of digital assets, cryptocurrency and security tokens.
...
`vendor.frontend` | optional Git URL for a development frontend repo | `git@github.com:cheeseswapbsc/baseapp.git`
...
- `app` - Peatio is the [crypto exchange software](https://www.cheeseswapbsc.com/), [Barong](https://github.com/cheeseswapbsc/barong) and the [Ambassador](https://www.getambassador.io) API gateway
...
```
ruby -e "$(curl -fsSL https://raw.githubusercontent.com/cheeseswapbsc/ndax/master/bin/install)"
```

## Happy trading with nDAX!
If you have any comments, feedback and suggestions, we are happy to hear from you here at GitHub or here: [crypto exchange software](https://www.b-cex.com/)
